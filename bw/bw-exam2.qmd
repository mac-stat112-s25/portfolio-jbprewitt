...
Goal: Show the answer as a 2 column table and as a graph. Sort countries based on consumption from largest to smallest. Use fcc dataframe.
...
Show the answer as a 3 column table (show the food category as the first column followed by country and consumption) and as a graph. For each food, sort the countries based on consumption from largest to smallest. Use the fcc dataframe. 
