...
Refer to the class website [here](https://hash-mac.github.io/stat112site-s25/activities/06-spatial-viz.html#exercises) for details.
...
### Part 1: Interactive points on a map with `leaflet` {.unnumbered}
...
### Part 2: Static points on a map {.unnumbered}
...
### Part 3: Choropleth maps {.unnumbered}
